...
range_1.value = 0;
range_1.addEventListener('input', (e) => {
...
range_2.value = 0;
range_2.addEventListener('input', (e) => {
    document.querySelector('#value_2').textContent = e.target.value
})
...
range_3.value = 0;
range_3.addEventListener('input', (e) => {
    document.querySelector('#value_3').textContent = e.target.value
})